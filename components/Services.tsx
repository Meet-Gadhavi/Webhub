    ...
    <section ref={containerRef} className="py-24 px-4 md:px-10 max-w-7xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {servicesList.map((service, index) => (
          <div key={index} className="service-card group bg-neutral-900 border border-neutral-800 p-8 rounded-2xl hover:border-blue-500/50 transition-colors duration-300">
            <div className="w-14 h-14 bg-neutral-800 rounded-xl flex items-center justify-center text-blue-500 mb-6 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">
              {service.icon}
            </div>
