...
const Services: React.FC = () => {
  ...
  return (
    <section ref={containerRef} className="relative py-24 px-4 md:px-10 overflow-hidden bg-neutral-950/50">
      {/* Background Effects */}
      <div className="service-blob-1 absolute top-0 right-0 w-[600px] h-[600px] bg-blue-600/5 rounded-full blur-[100px] pointer-events-none z-0 translate-x-1/3 -translate-y-1/3" />
      <div className="service-blob-2 absolute bottom-0 left-0 w-[600px] h-[600px] bg-purple-600/5 rounded-full blur-[100px] pointer-events-none z-0 -translate-x-1/3 translate-y-1/3" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div key={index} className="service-card group bg-neutral-900/80 backdrop-blur-sm border border-neutral-800 p-8 rounded-2xl hover:border-blue-500/50 transition-colors duration-300 shadow-xl">
                ...
                <p className="text-neutral-400 mb-6 h-20">{service.description}</p>
